class User < ActiveRecord::Base
  ...
  def self.set_user_from_twit(twitter_user)
	  if twitter_user.kind_of?(Hash)
			...
			if !user
				user = User.create!( :screen_name => twitter_user["screen_name"] ,:description => twitter_user["description"] ,:name => twitter_user["name"] , :twitter_id => twitter_user["id"],:pic_url => twitter_user["profile_image_url"],:nfollowers => twitter_user["followers_count"], :nfollowing => twitter_user["friends_count"])
